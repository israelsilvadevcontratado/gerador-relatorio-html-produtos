...
from utilitarios.utils import remover_caracteres_transformar_inteiro
...
def renderizar_template(objeto_arquivo_entrada):
    ...
    template_texto_pronto = template.render(cabecalho=objeto_arquivo_entrada.cabecalho,
                                            ...
                                            dicionario_media_preco_por_marca=media_preco_por_marca,
...
def criar_lista_com_precos_dos_produtos(produtos):
    ...
    for produto in produtos:
        preco_formatado = remover_caracteres_transformar_inteiro(produto.preco)
